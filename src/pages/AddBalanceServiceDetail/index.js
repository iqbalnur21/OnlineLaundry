...
export default class AddBalanceServiceDetail extends Component {
    ...
    return (
      ...
      <Image source ={logo} style = {styles.Logo} />
        ...
        <View style={styles.container}>
          ...
          <ButtonIcon title="Add Balance" type="Service" />
          </View>
          <View style={styles.desc}>
            <Text style={styles.nama}>Add Balance Service</Text>
